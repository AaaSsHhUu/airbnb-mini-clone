...
const { index, newData, newListing, showListing, editLsting, updateListing, deleteListing, categoryListing } = require("../controller/listingController.js");
...
// category route
router.get("/category/:type", wrapAsync(categoryListing))
